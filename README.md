...
- `VITE_SITE_URL` : origine absolue utilisée pour les URLs SEO (canonical, hreflang, og:url, JSON-LD, sitemap, robots.txt). Défaut : `https://powerprestation.ca`. À surcharger si le domaine de production change.
